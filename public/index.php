...
// On démarre les sessions au TOUUUUUT début du script MAIS
// après l'autoload, car si on met des objets dans nos sessions
// il faut que PHP sache retrouver les classes correspondantes
session_start();
...
// Exemple route en POST
//? $router->map( 'POST', '/route/post', '\App\Controllers\ControllerExample::methodeExample', 'routeNameExample' );
